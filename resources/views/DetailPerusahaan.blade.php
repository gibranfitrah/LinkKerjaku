...
<!-- Section Pertama -->
<section style="background-color: #FFFFFF; padding: 50px; display: flex; align-items: center; justify-content: right;">
...
<img src="img/profile1.jpg" alt="Profile Image" style="width: 100%; height: auto;">
<!-- Section Akhir -->
...
<div style="margin-top: 50px;">
  ...
  <div style="display: flex;">
    <div style="background-color: #CDCDCD; width: 207px; height: 207px; margin-right: 10px; border-radius: 10px;"></div>
    <div style="background-color: #CDCDCD; width: 207px; height: 207px; margin-right: 10px; border-radius: 10px;"></div>
    <div style="background-color: #CDCDCD; width: 207px; height: 207px; border-radius: 10px;"></div>
  </div>
  <button style="background-color: #2E3849; color: #FFFFFF; padding: 10px 20px; margin-top: 10px;">
...
<!-- Footer -->
<footer style="background-color: #E9EBF8; padding: 100px;">
    <div class="container">
        <div class="row">
