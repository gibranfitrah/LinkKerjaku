...
<section style="background-color: #FFFFFF; padding: 50px;">
    ...
    <div style="margin-top: -100px; margin-left: -25px; margin-bottom: 155px;">
            <h2 style="margin-top: 0; margin-left: 295px;">Olivia Rhye</h2>
            ...
            <div style="display: flex; align-items: center; margin-left: 295px; margin-top: -10px;">
                ...
                <img src="svg/link.svg" alt="Icon" style="width: 30px; height: 30px; margin-right: 10px;">
            </div>
            ...
            <a href="/disimpan" style="display: inline-block; width: 120px; height: 40px; background-color: #808080; border: none; border-radius: 8px; color: white; text-align: center; line-height: 40px; text-decoration: none;">
        Disimpan
    </a>        
</div>
...
semakin anda menonjol
        ...
        <h3 style="margin-left: -95px;">Resume</h3>
