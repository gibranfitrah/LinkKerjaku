...
<div style="display: flex; justify-content: center; align-items: center; height: 100vh;">
        <div style="width: 1200px; height: 900px; background-color: #FFFFFF; border-radius: 12px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 20px; box-sizing: border-box;">
            <div style="display: flex; align-items: center; margin-left: 75px; margin-top: 100px;">
                <img src="img/google1.png" alt="Profile Picture" style="width: 100px; height: 100px; border-radius: 50%;">
...
<div class="box" style="border: 2px solid #FFC94A; display: inline-block; padding: 10px; margin-left: 20px;">
    <img src="svg/save.svg" alt="save" class="icon" style="display: block; margin: 0 auto;">
            ...
            <h6 class="mt-5" style="margin-left: 100px; color: #146D9A;">Detail Pekerjaan</h6>
    ...
    <div style="display: flex; flex-direction: row; margin-top: -5px;">
            <div style="margin-left: -55px;">
                <h6 class="mt-5" style="margin-left: 155px;">Jenis Pekerjaan</h6>
                <div style="display: flex; margin-top: 15px; margin-left: 155px;">
        ...
        <div style="display: flex; flex-direction: row; margin-top: -5px;">
            <div style="margin-left: -55px;">
                <h6 class="mt-5" style="margin-left: 155px;">Keterampilan</h6>
                <p style="margin-bottom: 10px; margin-left: 155px; width: 400px; text-align: justify;">
    ...
    <p style="margin-bottom: 10px; margin-left: 155px; width: 400px; text-align: justify;">
        HARD : DevOps, Cloud Computing, Keamanan Siber
            ...
            <div>
                <h6 class="mt-5" style="margin-left: 195px;">Jenjang Pendidikan</h6>
                <p class="paragraph paragraf5" style="margin-bottom: 10px; margin-left: 195px; margin-right: 60px;">
                Minimal S1
                </p>
            </div>
        </div>
        ...
        <div style="display: flex; flex-direction: row; margin-top: -5px;">
            <div style="margin-left: -55px;">
                <h6 class="mt-5" style="margin-left: 155px;">Jenis Kelamin</h6>
                <p style="margin-bottom: 10px; margin-left: 155px; width: 400px; text-align: justify;">
       Laki-Laki
    </p>
            </div>
            <div>
                <h6 class="mt-5" style="margin-left: 195px;">Kota</h6>
                <p class="paragraph paragraf5" style="margin-bottom: 10px; margin-left: 195px; margin-right: 60px;">
                Surabaya
                </p>
            </div>
        ...
        <div style="display: flex; flex-direction: row; margin-top: -5px;">
            <div style="margin-left: -55px;">
                <h6 class="mt-5" style="margin-left: 155px;">Alamat Lengkap</h6>
                <p style="margin-bottom: 10px; margin-left: 155px; width: 400px; text-align: justify;">
                Jalan Sudirman No. 12, RT 002/RW 005, Menteng, Jakarta Pusat, 10310
    </p>
            </div>
            <div>
                <h6 class="mt-5" style="margin-left: 195px;">Kode pos</h6>
                <p class="paragraph paragraf5" style="margin-bottom: 10px; margin-left: 195px; margin-right: 60px;">
                12345
                </p>
            </div>
