...
<a href="/Page-LowonganKerja" class="sidebar-link"  style="color: #FCDC94;">
  ...
  <li class="breadcrumb-item">
                ...
                <li class="breadcrumb-item active" style="margin-left: 5px;" aria-current="page"><a href="/Page-SimpanProfill">Profill Disimpan</a></li>
  </ol>
</nav>
    </div>
...
<div style="width: 155px; height: 155px; background-color: #A0A0A0; border-radius: 50%; margin-right: 125px; margin-top: -85px; margin-left: 100px; position: relative; overflow: hidden;">
    ...
    Read more
        ...
        <form>
            <input type="text" style="width: 910px; height: 150px;  border: 1px solid black; border-radius: 8px; padding: 5px; margin-bottom: 20px; margin-top: 10px; padding-left: 30px;" value="Memberikan Standar Kerja">
        </form>
            </div>
    ...
    <select style="width: 910px; height: 70px; border: 1px solid black; border-radius: 8px; padding: 5px; margin-bottom: 20px; margin-top: 10px; padding-left: 30px;">
        <option value="Industri Sekunder">Industri Sekunder</option>
        <option value="Industri Primer">Industri Primer</option>
        <option value="Industri Tersier">Industri Tersier</option>
        <option value="Industri Kuarter"> Industri Kuarter</option>
    </select>
</form>        
            </div>
    ...
    <select style="width: 910px; height: 70px; border: 1px solid black; border-radius: 8px; padding: 5px; margin-bottom: 20px; margin-top: 10px; padding-left: 30px;">
        ...
        <form>
            <input type="text" style="width: 910px; height: 70px;  border: 1px solid black; border-radius: 8px; padding: 5px; margin-bottom: 20px; margin-top: 10px; padding-left: 30px;" value="Jakarta Selatan">
        </form>
            </div>
