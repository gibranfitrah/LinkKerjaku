  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarText"
        ...
        <div class="collapse navbar-collapse" id="navbarText">
            ...
            <li class="nav-item">
                    <a class="nav-link active ms-4" aria-current="page" href="/Home-Perusahaan" style="color: #082A3C;">Beranda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active ms-4" aria-current="page" href="/About-Perusahaan" style="color: #146D9A;">About Us</a>
                </li>
                <li class="nav-item">
    ...
    <a href="#" class="btn btn-secondary" role="button" style="background-color: white; border: 2px solid #FFC94A; color: #000000; margin-right: 15px;">
        Sign In
    </a>
    <a href="#" class="btn btn-secondary" role="button" style="background-color: #FFC94A; border: none; color: #000000;">
        Sign Up
    </a>
</div>
