...
<div style="width: 155px; height: 155px; background-color: #A0A0A0; border-radius: 50%; margin-right: 125px; margin-top: -85px; margin-left: 100px; position: relative; overflow: hidden;">
    ...
    <!-- Text Input with Pre-filled Value -->
    <input type="text" id="experience" name="experience" style="width: 1013px; height: 70px; margin-bottom: 10px; padding: 8px; padding-left: 30px;" value="2019-2021: Asisten pemasaran di perusahaan C.">
...
<h5 style="text-align: left; margin-top: 100px; color: #146D9A;">Ringkasan Pribadi</h5>
<form>
    <textarea id="comment" name="comment" rows="4" cols="50" style="width: 1013px; height: 231px; border-radius: 10px; margin-bottom: 10px; margin-top: 15px; padding-left: 30px; padding-top: 15px;">
Seorang Developer dan Seorang UIUX Designer
    </textarea><br>
    <span id="wordCount" style="margin-left: 900px;">0/300 kata</span>
        ...
        <form style="margin-top: 10px;">
            <!-- Text Input -->
            <input type="text" id="experience" name="experience" style="width: 1013px; height: 70px; margin-bottom: 10px; padding: 8px; padding-left: 30px;" value="2018: SMA Negeri 1 Yogyakarta">
...
function countWords(str) {
        // Remove whitespace from start and end, then split by spaces
        const words = str.trim().split(/\s+/);
        // If input is empty, return 0
        return words[0] === "" ? 0 : words.length;
    }

    // Get textarea and wordCount span
    const textarea = document.getElementById('comment');
    const wordCountSpan = document.getElementById('wordCount');

    // Initial word count
    const initialText = textarea.value;
    wordCountSpan.textContent = `${countWords(initialText)}/300 kata`;
    ...
    textarea.addEventListener('input', function() {
        ...
        // Update the word count span
        wordCountSpan.textContent = `${wordCount}/300 kata`;
    });
