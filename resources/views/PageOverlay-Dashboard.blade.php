...
<h4 class="mt-5" style="margin-left: 25px; color: #146D9A; font-size: 20px;">Detail Singkat</h4>
      ...
      Saya Olivia Rhye, seorang profesional ahli dalam Desain UI/UX, Riset Pemasaran, dan Pemasaran Digital.</p>
      <p style="margin-left: 25px; margin-top: -15px;">Dengan keahlian saya dalam desain yang menarik dan penelitian pasar yang teliti, serta kemampuan saya</p>
      <p style="margin-left: 25px; margin-top: -15px;">dalam strategi pemasaran digital, saya menghadirkan solusi-solusi yang efisien dan memikat...</p>

<h4 class="mt-5" style="margin-left: 25px; color: #146D9A; font-size: 20px;">Kualifikasi Pendidikan</h4>
      <p class="paragraf5" style="margin-left: 25px; margin-right: 60px;">
      Sarjana Teknik Informatika (S.Kom.) <span style="margin-left: 455px; margin-top: 10px;">2012-2016</span></p>

<h4 style="margin-left: 25px; color: #146D9A; font-size: 20px; margin-top: 75px;">Detail Kontak</h4>
      <p class="paragraf5" style="margin-left: 25px; margin-right: 60px;">
      Alamat Lengkap : Jalan Sudirman No. 12, RT 002/RW 005, Menteng, Jakarta Pusat, 10310</p>
      <p style="margin-left: 25px; margin-top: -10px;">Email : <span style="color: #FF8585;">rhyeolivia77@gmail.com</span></p>
      <p style="margin-left: 25px; margin-top: -10px;">Nomor Telepon : (+62) 812 3331 5476</p>
