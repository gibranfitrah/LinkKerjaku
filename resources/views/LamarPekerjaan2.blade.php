...
<a href="/LamarPekerjaan" style="text-decoration: none; margin-left: auto; margin-right: 855px; margin-top: -55px;">
...
<a href="/LamarPekerjaan3" style="text-decoration: none; margin-left: auto; margin-right: 100px; margin-top: -55px;">
    <button type="submit" style="background-color: #FFC94A; border: none; border-radius: 8px; color: #000000; padding: 10px;">
        Selanjutnya
    </button>
</a>
