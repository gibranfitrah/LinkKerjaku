...
<html lang="en">
  <head>
    ...
    <title>Link-Kerjaku | About Pelamar</title>
...
<section style="background-color: #1679AB; padding: 50px 0;">
    <div class="container">
        ...
        <div style="display: flex; justify-content: center; margin-top: 20px;">
        <a href="/DetailPekerjaan" style="display: inline-block; width: 373px; height: 58px; background-color: #FFC94A; color: #000000; text-align: center; line-height: 58px; text-decoration: none; border: none; border-radius: 5px;">
    Lamar Pekerjaan Ini
</a>
