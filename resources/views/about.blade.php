...
<!-- Section Kesepulu -->
<section style="background-color: #FFFFFF; padding: 60px; text-align: justify;">
    <div>
        <h3 style="text-align: center; color: #1679AB;">Daftar di Link Kerjaku hari ini dan temukan peluang baru dengan aman!</h3>
    </div>
    <div class="row mt-5">
    <div class="col-sm-6">
        <div class="card" style="width: 600px; height: 235px; background-color: #1679AB; border-radius: 40px; margin-top: 20px; margin-left: 50px;">
            <div class="card-body">
                ...
                <a href="#" class="btn" style="background-color: #FFC94A; margin-top: 15px; text-decoration: none; color: #000000; padding: 8px 16px; border: none; border-radius: 4px;">Buka Lowongan Sekarang</a>
            </div>
        </div>
    </div>
    <div class="col-sm-6">
        <div class="card" style="width: 600px; height: 235px; background-color: #1679AB; border-radius: 40px; margin-top: 20px;">
            <div class="card-body">
                ...
                <p class="card-text text-left" style="color: #FFFFFF;">Mari kita bersama-sama membentuk ekosistem talenta! Jika Anda ingin menampilkan kami atau menjajaki peluang kemitraan, cukup isi formulir di bawah ini dan tim kami akan segera menghubungi Anda.</p>
                <a href="#" class="btn" style="background-color: #FFC94A; margin-top: 15px; text-decoration: none; color: #000000; padding: 8px 16px; border: none; border-radius: 4px;">Lamar Pekerjaan Ini</a>
            </div>
        </div>
    </div>
</div>
