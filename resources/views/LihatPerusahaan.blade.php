...
<html lang="en">
  <head>
    ...
    <title>Link-Kerjaku | Detail Company</title>
...
<div style="margin-right: 10px;">
    ...
    <p>Semua yang perlu Anda ketahui tentang perusahaan, semuanya di satu tempat</p>
    ...
    <div class="card" style="width: 392px; height: 306px; border-radius: 20px; background-color: #8E98A8;">
        <div class="card-body">
        </div>
    </div>
</div>
            ...
            <div class="col-md-3 card-col">
                <div class="card" style="border-radius: 16px;">
                    <div class="card-body">
                        ...
                        <a href="/profilecompany" class="btn" style="background-color: #E3F2FB; color: #1D559D; margin-left: 20px; margin-top: 20px;">82 Jobs</a>
                    </div>
                </div>
            </div>
            <div class="col-md-3 card-col">
                <div class="card" style="border-radius: 16px;">
                    <div class="card-body">
                        ...
                        <button class="btn" style="background-color: #E3F2FB; color: #1D559D; margin-left: 20px; margin-top: 20px;">82 Jobs</button>
                    </div>
                </div>
            </div>
            <div class="col-md-3 card-col">
